...
def get_timeline_data():
    """
    Returns the professional journey events. 
    Using Emojis instead of external images to improve LCP (performance).
    """
    return [
...
# Building a single HTML block to stabilize layout and boost performance
